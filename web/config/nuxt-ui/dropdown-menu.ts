import type { DropdownMenuConfig } from '../../types/nuxt-ui';

export default {
  slots: {
    // * Changes: a floating menu is still a panel (annex §6) — the hairline ring and generic shadow give way to the panel treatment.
    // * Changes: both menus (build, account) share one minimum width.
    // * Default: leading 'min-w-32 bg-default shadow-lg rounded-md ring ring-default overflow-hidden'
    content:
      'min-w-48 panel bg-default shadow-none ring-0 rounded-md overflow-hidden data-[state=open]:animate-[scale-in_100ms_ease-out] data-[state=closed]:animate-[scale-out_100ms_ease-in] origin-(--reka-dropdown-menu-content-transform-origin) flex flex-col',
    viewport:
