...
- `web/components/HeroRosterStrip.vue`: one strip, its tile refs, and the follow on click; `web/components/HeroDetailDialog.vue`: the two strip instances and the watcher that asks both to follow.
