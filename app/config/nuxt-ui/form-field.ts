...
export default {
  slots: {
    ...
    // * Changes: a field label is the annex's label role — condensed, uppercase, tracked, and toned rather than full ink so the control it names stays the loudest thing in the group.
