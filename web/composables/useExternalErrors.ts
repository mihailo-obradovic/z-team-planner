 ...
 *
 * A copy rather than the source itself: Regle clears a field's entry as the user edits it, and
 * it must not write back into state derived from the mutation's error.
 */
