...
The first threshold is 77rem and not the 78 that 1280 maps to, because 1280 maps to *either* 1248 or 1238 depending on that scrollbar: at 78rem the desktop layout's own width lands inside the split tier. A threshold that has to hold at a named viewport needs margin for the scrollbar, not the nominal figure.
