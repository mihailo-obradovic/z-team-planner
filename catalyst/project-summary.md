...
| 021 | Hero portraits                | Draft  | One lossless square master per hero at 960 (512 where no larger bust exists), re-cut under one framing rule with Blonde Blazer from the Training render, and the Nuxt Image configuration that serves each usage site its own width at quality 80 through the Vercel provider with a one-year edge cache.                                                                                                                                       | [021_hero-portraits](features/021_hero-portraits.md)                             |
