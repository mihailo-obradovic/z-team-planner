...
6. For every stateful component the skeleton introduces (broker, database, cache, IdP), add its section to `operations.md` — Operate / Recovery / Quirks (`references/project-documents.md`).
