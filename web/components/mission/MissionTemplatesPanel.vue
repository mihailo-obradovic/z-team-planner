  ...
  <section class="w-fit bg-default panel">
    ...
    <div class="flex flex-col gap-2 p-3">
      ...
      >
        ...
        <!-- * Collapsed: the five REQs at a glance, in radar axis order like every stat list. -->
        <ul
          v-if="index !== activeIndex"
          class="flex gap-3 border-t border-muted px-3 py-2"
        >
          <li
          ...
          >
            <u-icon :name="STAT_ICONS[stat]" class="size-4" />
        ...
        >
          ...
          <span class="text-center font-heading text-tag text-dimmed uppercase">
            REQ
          </span>
          <span class="text-center font-heading text-tag text-dimmed uppercase">
            2×XP ≥
