...
| bust                           | PNG                      | Fandom `dispatch` wiki, `<Name>.png`     | the fuller framing (horns, ears, collars visible), native 450–512px; the only source of that framing — wiki.gg's 960×1040 busts crop tighter |
