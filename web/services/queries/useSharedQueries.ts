...
export function useFetchSharedBuild(
  ...
  // * No `enabled` gate on auth: the public read works signed out, which is the whole point of a share link. Nothing here invalidates anything either (feature 007).
