...
| 004 | Accounts                      | Draft  | Optional Google sign-in via Firebase: a user record with a declared personal-data policy, a profile endpoint, total self-service deletion across both systems, and a one-time offer to keep local builds. | [004_accounts](features/004_accounts.md)                   |
