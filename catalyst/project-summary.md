...
| 021 | Hero portraits                | Approved | One lossless 512 master per hero on one canvas — Fandom's fuller-framed busts padded, never cropped or upscaled, Blonde Blazer re-cut from the Training render — and the Nuxt Image configuration that serves each usage site its own width at quality 80 through the Vercel provider with a one-year edge cache.                                                                                                                               | [021_hero-portraits](features/021_hero-portraits.md)                             |
